...
class PathwayAnalyzer:
    """Pathway expression matrix transformation
    It takes the gene expression matrix and the pathway file
    and get the pathway expression matrix
    ...
    Attributes:
    --------------
        pathways  : pandas DataFrame
            A two columns pandas DataFrame with corresponding 
            ensemble ids.
